...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("w-fit bg-white shadow border-gray-200", defaultClassNames.root),
        months: cn("flex flex-col gap-2 md:flex-row", defaultClassNames.months),
        month: cn("flex w-full flex-col gap-2 text-gray-900", defaultClassNames.month),
        ...
        month_caption: cn("flex h-[--cell-size] w-full items-center justify-center px-[--cell-size] text-gray-100", defaultClassNames.month_caption),
        dropdowns: cn("flex h-[--cell-size] w-full items-center justify-center gap-1.5 text-sm font-medium", defaultClassNames.dropdowns),
        dropdown_root: cn("border border-gray-200", defaultClassNames.dropdown_root),
        dropdown: cn("bg-white absolute inset-0 opacity-0", defaultClassNames.dropdown),
        caption_label: cn("select-none font-medium text-gray-100", captionLayout === "label" ? "text-sm" : "[&>svg]:text-muted-foreground flex h-8 items-center gap-1 pl-2 pr-1 text-sm [&>svg]:size-3.5", defaultClassNames.caption_label),
        table: "w-full border-collapse",
        weekdays: cn("flex border-b border-gray-200", defaultClassNames.weekdays),
        weekday: cn("text-gray-400 flex-1 select-none text-[0.8rem] font-medium", defaultClassNames.weekday),
        week: cn("mt-2 flex w-full", defaultClassNames.week),
        week_number_header: cn("w-[--cell-size] select-none", defaultClassNames.week_number_header),
        week_number: cn("text-gray-400 select-none text-[0.8rem]", defaultClassNames.week_number),
        day: cn("group/day relative aspect-square h-full w-full select-none p-0 text-center bg-white hover:bg-gray-100 transition hover:border-gray-200"),
        ...
        today: cn("bg-gray-100 text-gray-700 border border-gray-300", defaultClassNames.today),
