      ...
      <div className="flex items-center justify-between mb-4 -mt-6 w-full">
        ...
        <div className="flex items-center gap-3">
          <div className="relative group/avatar-roster">
            ...
            <div className="absolute right-full top-0 flex items-center gap-3 transition-all duration-300 ease-in-out opacity-0 pointer-events-auto group-hover/avatar-roster:opacity-100 group-hover/avatar-roster:pointer-events-auto"></div>
