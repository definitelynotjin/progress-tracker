  ...
  return (
    <div className="flex flex-row gap-4 rounded-xl overflow-auto bg-gray-800 p-16 min-h-screen">
      <div className="w-1/4 bg-gray-700 rounded-lg p-6 shadow-lg">
        ...
        {/* Team members list */}
        <ul className="space-y-2">{/* Example team member */}</ul>
      ...
      <div className="w-3/4 bg-gray-700 rounded-lg p-6 shadow-lg">
        <h2 className="text-xl font-bold text-white mb-4">Manage Teams</h2>
        ...
        <form className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full h-10 bg-gray-800 hover:bg-gray-900 text-white p-3 rounded-md"
          >
            Add Member
          </Button>
        </form>
