...
CustomWeekView.range = (date: Date, { localizer }: { localizer: DateLocalizer }) => {
    const start = date;
...
CustomWeekView.navigate = (date: Date, action: NavigateAction, { localizer }: { localizer: DateLocalizer }) => {
    switch (action) {
...
CustomWeekView.title = (date: Date, { localizer }: { localizer: DateLocalizer }) => {
